...
<!-- The dataset originating from the Mr. Trash Wheel Baltimore Healthy Harbor initiative embodies a significant real-world impact in combating environmental degradation by removing trash from waterways. 
This initiative is pivotal in addressing pressing environmental concerns, emphasizing the paramount importance of environmental conservation. 
However, working with this dataset may pose certain challenges, such as data inconsistencies or gaps, necessitating meticulous preprocessing and analytical methodologies to derive meaningful insights accurately. 
Within this dataset lie multifaceted dimensions of data, including trash weight, volume, and specific item counts like plastic bottles and cigarette butts. 
Such diverse data attributes offer a rich landscape for exploration and visualization, enabling comprehensive analyses of trash accumulation and composition. 
Through techniques such as line charts, bar charts, and box plots, temporal and comparative analyses become feasible, facilitating the identification of trends, seasonal variations, and disparities among different Trash Wheels. 
Moreover, the dataset's unique attribute, "HomesPowered," underscores the potential renewable energy benefits of waste management efforts, thereby reinforcing the significance of recycling and resource recovery in environmental sustainability endeavors. 
Overall, this dataset presents an invaluable opportunity to delve into environmental issues through the lens of data visualization, fostering a deeper understanding of the intricate dynamics between human activity and environmental well-being. 
Our group employs two questions to analyze the data, alongside various charts including bar charts, line charts, and box plots, to interpret the significance of the data.  -->
...
<!-- Understanding the composition of collected trash over time (Month and Year) is pivotal for comprehensively addressing environmental concerns. 
This analysis aims to explore the relationship between the quantities of plastic bottles, polystyrene items, and glass bottles collected by each Trash Wheel in various months and years.
By delving into this inquiry, we seek to uncover patterns and variations in waste composition, which can offer crucial insights into the effectiveness of waste management strategies and environmental conservation efforts.
To address this question, essential components of the dataset include information regarding the Trash Wheel identifiers (ID), the quantities of plastic bottles, polystyrene items, and glass bottles collected, and the temporal attributes of Month and Year.
These elements enable us to track the distribution and fluctuations of different types of waste over time.

This question is of significant interest due to its direct relevance to environmental sustainability and waste management practices.
Understanding how the composition of collected trash provides valuable insights into the sources and distribution of pollutants in water bodies.
Moreover, uncovering trends and patterns in waste composition can inform targeted interventions and policy initiatives aimed at mitigating pollution and promoting ecosystem health.
Therefore, this analysis holds the potential to contribute meaningfully to the ongoing efforts towards environmental conservation and sustainable waste management.  -->
...
Lastly, we will investigate the trend of weight and volume of collected waste specifically in the year 2018.
For this purpose, we will utilize a combination of line chart and bar chart.
This approach will provide a holistic view of waste trends in 2018, leveraging the strengths of both chart types to depict variations in weight and volume across different months.
By employing a diverse range of plot types, we aim to uncover nuanced insights into the dynamics of collected waste over time, facilitating informed decision-making and environmental management strategies.  -->
