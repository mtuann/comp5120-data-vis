...
heatmap(data_cor, Rowv = NA, Colv = NA, col = cm.colors(256), scale = "none", cexRow = 0.75, cexCol = 0.75, 
        main = "Fig 8. Heatmap of Different Types of Trash")

# Define colors from blue to white to red
# colors <- c("blue", "white", "red")

# Generate color palette based on the correlation range
# legend_colors <- colorRampPalette(colors)(256)
...
# legend("topright", legend = seq(-1, 1, by = 0.2), fill = legend_colors, title = "Correlation", cex = 0.8)

# # Set the size of the main title and axis labels
# par(cex.main = 0.8, cex.axis = 0.8, cex.lab = 0.8)


# legend("topright", legend = c(-1, -0.8, -0.6, -0.4, -0.2, 0, 0.2, 0.4, 0.6, 0.8, 1), fill = colorRampPalette(c("blue", "white", "red"))(256), title = "Correlation", cex = 0.8)
```
...
The Figure 8 illustrates the correlation between different types of waste summarized by year. The heatmap indicates a strong positive correlation (depicted by red color) among polystyrene, plastic bags, cigarette butts, glass bottles, and wrappers, while the correlation between other types of waste is weak (depicted by white color). Additionally, there is a strong negative correlation (depicted by blue color) between weight, volume, and plastic bottles, sport balls, and homes power, whereas the relationship between wrappers, plastic bags, and homes power is strong (depicted by light red color). This suggests that wrappers and plastic bags are the types of waste that contribute more to creating homes power. Furthermore, weight and volume exhibit a strong positive relationship with home power.
